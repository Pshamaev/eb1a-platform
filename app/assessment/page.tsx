...
const T: Record<Lang, Record<string, any>> = {
  ...
  ru: {
    ...
    q: {
      ...
      niw_importance: { label: "Кто выиграет от вашей работы в США?", sublabel: "Национальное значение = влияние за пределами одного работодателя", opts: ["Вся страна (все США)","Несколько штатов / регион","Только один город или местный рынок","Сложно определить"] },
  ...
  hi: {
    ...
    q: {
      ...
      niw_importance: { label: "लाभार्थी?", sublabel: "राष्ट्रीय = एकल नियोक्ता से परे", opts: ["पूरा अमेरिका","बहु-राज्य","केवल स्थानीय","अनिश्चित"] },
  ...
  es: {
    ...
    q: {
      ...
      niw_importance: { label: "¿Quién se beneficia en EE.UU.?", sublabel: "Nacional = más allá de un empleador", opts: ["Todo EE.UU.","Multi-estatal","Solo local","Difícil definir"] },
  ...
  pt: {
    ...
    q: {
      ...
      niw_importance: { label: "Quem se beneficia nos EUA?", sublabel: "Nacional = além de um empregador", opts: ["Todo EUA","Multi-estadual","Apenas local","Difícil definir"] },
    ...
    if (blockIdx === BLOCKS.length - 1) {
      ...
      try {
        ...
        const res = await fetch("/api/assess", {
          ...
          body: JSON.stringify({ answers: readableAnswers, lang })
        })
