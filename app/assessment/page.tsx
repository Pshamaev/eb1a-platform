...
const T: Record<Lang, Record<string, any>> = {
  en: {
    ...
    cta_build: "Deep AI Analysis — $49",
    cta_expert: "Attorney Review — $299",
    ...
    disclaimer_cta: "Attorney Review — $299",
  ...
  ru: {
    ...
    cta_build: "Глубокий AI анализ — $49",
  ...
  es: {
    ...
    disclaimer_cta: "Revisión de abogado — $299",
  ...
  pt: {
    ...
    disclaimer_cta: "Revisão de advogado — $299",
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="grid gap-3">
          <button onClick={() => window.location.href = "/deep-analysis"} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition-colors shadow-md text-sm">{t.cta_build}</button>
                  <SignedIn>
